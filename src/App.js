...
import { Message, MessagePage } from './entities/messages/message';

import { MessageModal } from './entities/advertisement/message_modal';
import {DemoMessagePage} from './entities/messages/message_page';
...
const AppLayout = (props) => {
  ...
  return (
    ...
    <Nav>
        ...
        <Nav.Link as={Link} to={root + "/messages/message/:1"}>Zpravy</Nav.Link>
    </Nav> 
     <MessageModal />
    <Outlet />
    </Container>
    ...
    <>
      <Router>
        <Routes>
          ...
          {/* <Route element={<MessageModal/>}></Route> */}
          ...
          <Route path={root + "/messages/"} element={<AppLayout />}>
            <Route index element={<AppLayout />} />
          ...
          <Route exact path={root + '/pp'} element={<DemoMessagePage/>}>
          </Route>
